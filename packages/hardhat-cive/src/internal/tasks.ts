...
const AUTOGENERATED_FILE_PREFACE = `// This file was autogenerated by @civex/hardhat-cive, do not edit it.
  // prettier-ignore
  // tslint:disable
  // eslint-disable`
...
function generateContractDeclaration(artifact: Artifact, isDuplicate: boolean) {
  ...
  import type { Address } from "cive";
  ${
    inputs.length > 0
      ? `import type { AbiParameterToPrimitiveType, GetContractReturnType } from "@civex/hardhat-cive/types";`
      : `import type { GetContractReturnType } from "@civex/hardhat-cive/types";`
  }
  import "@civex/hardhat-cive/types";
  
  export interface ${contractTypeName} ${json}
  
  declare module "@civex/hardhat-cive/types" {
    ${validNames
      .map(
